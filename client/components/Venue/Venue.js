        ...
        <section className="container venue">
            ...
            <div className="lodging">
                ...
                <article>
                    ...
                    <p>
                        <a target="_blank" href="https://www.lonestarcourt.com/">Visit Website</a>
                    </p>
                </article>
                <article>
                    ...
                    <p>
                        <a target="_blank" href="https://us01.iqwebbook.com/TVAFTX655/">Visit Website</a>
                    </p>
                </article>
                <p className="disclaimerText">* We highly recommended you rent a car as the venue is about 45 minutes from the hotel room blocks at the Domain. While Uber and Lyft also travel to the venue location, we highly suggest you arrange your return trip with them in advance as it will take them time to get to the venue.</p>
            </div>
      </section>
    )
  }
